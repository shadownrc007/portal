...
{{-- Style Here --}}
    ...
    <link rel="stylesheet" href="{{asset('plugins/src/autocomplete/css/autoComplete.02.css')}}">
...
@section('scripts')
{{-- Scripts Here --}}
<script src="{{asset('plugins/src/autocomplete/autoComplete.min.js')}}"></script>
<script src="{{asset('plugins/src/autocomplete/custom-autoComplete.js')}}"></script>
@endsection