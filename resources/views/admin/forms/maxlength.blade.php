...
{{-- Scripts Here --}}
    ...
    <script src="{{asset('plugins/src/bootstrap-maxlength/bootstrap-maxlength.js')}}"></script>
    <script src="{{asset('plugins/src/bootstrap-maxlength/custom-bs-maxlength.js')}}"></script>
@endsection