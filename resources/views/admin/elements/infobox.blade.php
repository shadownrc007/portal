        ...
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area text-center">
                <div class="info-box-2">
                    <div class="info-box-2-bg" style="background: url({{Vite::asset('resources/images/infobox-1.jpg')}}) center center / cover;"></div>
        ...
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area text-center">
                ...
                <div class="info-box-4">
                    <div class="info-box-4-bg" style="background: url({{Vite::asset('resources/images/infobox-1.jpg')}}) center center / cover;"></div>
