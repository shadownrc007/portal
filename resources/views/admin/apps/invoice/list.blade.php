            ...
            <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="/app/invoice/preview"><span class="inv-number">#098424</span></a></td>
                        <td>
                            <div class="d-flex">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#095841</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#091768</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#089472</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#087916</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#086773</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#086643</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#084743</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#082693</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#081681</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#081452</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#081451</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#098425</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#098445</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#099825</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#099835</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#099859</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#099989</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#101261</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
                    ...
                    <tr>
                        <td class="checkbox-column"> 1 </td>
                        <td><a href="/app/invoice/preview"><span class="inv-number">#102261</span></a></td>
                        <td>
                            <div class="d-flex">
                                <div class="usr-img-frame me-2 rounded-circle">
