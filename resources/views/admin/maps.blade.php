...
{{-- Style Here --}}
    ...
    <link rel="stylesheet" href="{{asset('plugins/src/leaflet/leaflet.css')}}">
...
@section('scripts')
{{-- Scripts Here --}}
    <script src="{{asset('plugins/src/leaflet/us-states.js')}}"></script>
    <script src="{{asset('plugins/src/leaflet/eu-countries.js')}}"></script>
    <script src="{{asset('plugins/src/leaflet/leaflet.js')}}"></script>
    <script src="{{asset('plugins/src/leaflet/leaflet_script.js')}}"></script>
@endsection