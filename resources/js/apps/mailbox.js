$(document).ready(function() {
	...
	document.getElementById('inboxAll').addEventListener('click', function() {
		...
		if (getActiveList[0].id === 'personal' || getActiveList[0].id === 'work' || getActiveList[0].id === 'social' || getActiveList[0].id === 'private') {
			...
			for (var i = 0; i < getItemsGroupCheckboxes.length; i++) {
				...
				let getItemsCheckboxes = document.querySelectorAll('.'+getItemsGroupCheckboxes[i].parentNode.parentNode.parentNode.className.split(' ')[0] + ' ' + getActiveListID + ' .inbox-chkbox');
			...
			let getItemsCheckboxes = document.querySelectorAll('.mail-item'+getActiveListID + ' .inbox-chkbox');
	...
	*/
	...
	let getEmailToInput = document.getElementById('m-to');

	getEmailToInput.addEventListener('input', function() {

	  	let getEmailToInputValue = this.value;
	...
	let getCCEmailInput = document.getElementById('m-cc');
	getCCEmailInput.addEventListener('input', function() {

	    let getCCEmailInputValue = this.value;
	...
	let getSubjectInput = document.getElementById('m-subject');

	getSubjectInput.addEventListener('input', function() {

	  let getSubjectInput = this.value;
