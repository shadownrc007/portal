...
let getNameInput = document.getElementById('c-name');

getNameInput.addEventListener('input', function() {

  let getNameInputValue = this.value;
...
let getEmailInput = document.getElementById('c-email');

getEmailInput.addEventListener('input', function() {

    let getEmailInputValue = this.value;
...
let getPhoneInput = document.getElementById('c-phone');

getPhoneInput.addEventListener('input', function() {

  let getPhoneInputValue = this.value;
